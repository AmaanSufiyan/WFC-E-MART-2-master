...
function getPreservedProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'processed & preserved meat'";
    $stmt = $pdo->prepare($query);
    $stmt->execute();
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$products = getPreservedProducts($pdo);
