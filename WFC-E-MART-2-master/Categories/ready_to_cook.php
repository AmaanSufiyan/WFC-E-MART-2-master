...
function getReadyToCookProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'frozen ready to cook'";
    $stmt = $pdo->prepare($query);
    $stmt->execute();
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$products = getReadyToCookProducts($pdo);
...
<head>
    ...
    <title>Frozen Ready To Cook Products</title>
    <script src="https://kit.fontawesome.com/b262aa5062.js" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"/>
    <link rel="stylesheet"  type="text/css" href="../CSS/ready_to_cook.css"/>
</head>
<body>
    ...
    <div class="heading">
        <h1>ready to cook snacks</h1>
        <p>
            <a href="../User pages/home.php">home >></a> 
            <a href="../User pages/all-products.php">products >></a>
            <a href="../Categories/frozen.php">frozen >></a>
            ready to cook snack</p>
    </div>

    <section class="products" style="margin-bottom: 10vh;">

        <div class="product-header">
            <h1 class="title">frozen ready to cook<span> snacks </span></h1>
            <div class="sort">
