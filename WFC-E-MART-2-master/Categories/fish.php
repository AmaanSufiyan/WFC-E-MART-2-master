...
function getFishProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'fish'";
    $stmt = $pdo->prepare($query);
    $stmt->execute();
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$products = getFishProducts($pdo);
...
<body>
    ...
    <section class="products" style="margin-bottom: 10vh;">
        ...
        <div class="product-header">
            <h1 class="title">fish <span> products </span></h1>
            <div class="sort">
