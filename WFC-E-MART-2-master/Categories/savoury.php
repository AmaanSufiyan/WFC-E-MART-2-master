...
function getSavouryProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'savoury'";
    $stmt = $pdo->prepare($query);
    $stmt->execute();
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$products = getSavouryProducts($pdo);
...
<body>
    ...
    <div class="heading">
        ...
        <p>
            ...
            <a href="../Categories/bakery.php">bakery >></a>
            savoury
        </p>
    </div>
    ...
    <section class="products" style="margin-bottom: 10vh;">
        ...
        <div class="product-header">
            <h1 class="title">savoury <span> products </span></h1>
            <div class="sort">
