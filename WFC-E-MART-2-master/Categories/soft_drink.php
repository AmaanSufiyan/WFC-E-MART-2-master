...
function getSportsDrinkProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'soft drinks'";
...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="../CSS/soft_drink.css"/>
</head>
<body>
    ...
    <section class="products" style="margin-bottom: 10vh;">
        ...
        <div class="product-header">
            <h1 class="title">soft drink <span> products </span></h1>
            <div class="sort">
