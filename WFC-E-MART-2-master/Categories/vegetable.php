...
function getVegtableProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'vegetable'";
    $stmt = $pdo->prepare($query);
    $stmt->execute();
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$products = getVegtableProducts($pdo);
...
<body>
    ...
    <section class="products" style="margin-bottom: 10vh;">
        ...
        <div class="product-header">
            <h1 class="title">vegetable <span> products </span></h1>
            <div class="sort">
