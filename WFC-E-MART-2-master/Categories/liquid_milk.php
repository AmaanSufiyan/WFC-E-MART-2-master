...
function getLiquidMilkProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'liquid milk'";
    $stmt = $pdo->prepare($query);
    $stmt->execute();
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$products = getLiquidMilkProducts($pdo);
...
<body>
    ...
    <div class="heading">
        ...
        <a href="../Categories/beverages.php">beverages >></a>
        liquid milks
        </p>
    </div>
    ...
    <section class="products" style="margin-bottom: 10vh;">
        ...
        <div class="product-header">
            <h1 class="title">liquid milk <span> products </span></h1>
            <div class="sort">
