...
function getBreadProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'bun'";
    $stmt = $pdo->prepare($query);
    $stmt->execute();
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$products = getBreadProducts($pdo);
...
<body>
    ...
    <section class="products" style="margin-bottom: 10vh;">
        ...
        <div class="product-header">
            <h1 class="title">bun <span> products </span></h1>
            <div class="sort">
