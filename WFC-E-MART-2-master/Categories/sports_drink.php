...
function getSportsDrinkProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'sports drinks'";
    $stmt = $pdo->prepare($query);
    $stmt->execute();
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$products = getSportsDrinkProducts($pdo);
...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="../CSS/sports_drink.css"/>
</head>
<body>
    ...
    <section class="products" style="margin-bottom: 10vh;">
        ...
        <div class="product-header">
            <h1 class="title">sports drink <span> products </span></h1>
            <div class="sort">
