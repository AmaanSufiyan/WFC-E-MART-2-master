...
function getReadyToEatProducts(object $pdo) {
    $query = "SELECT * FROM products WHERE subcategory = 'frozen ready to eat meals'";
    $stmt = $pdo->prepare($query);
    $stmt->execute();
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$products = getReadyToEatProducts($pdo);
...
<body>
    ...
    <section class="products" style="margin-bottom: 10vh;">
        ...
        <div class="product-header">
            <h1 class="title">frozen <span> ready to eat meals </span></h1>
            <div class="sort">
